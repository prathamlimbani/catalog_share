...
const PLANS: Plan[] = [
    ...
    },
    {
        ...
        productLimit: 300,
        features: ["Up to 300 Products", "Better Visibility", "Premium Themes", "Standard Support"],
    ...
    },
    {
        ...
        productLimit: 9999,
        features: ["500+ Products", "Custom Branding with Logo & Domain", "Premium Themes", "Priority & Call Support", "Featured Listing"],
...
export function SubscriptionDialog({ companyId, companyName, companyEmail, currentPlan, children }: SubscriptionDialogProps) {
    ...
    const handleSubscribe = (plan: Plan) => {
        ...
        subscribe(plan.id, plan.name, plan.price, () => setOpen(false));
    };
