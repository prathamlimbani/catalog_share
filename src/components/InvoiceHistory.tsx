    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-9 bg-white border-slate-200 focus:border-blue-400 focus:ring-blue-400/20"
        />
      </div>
                  ...
                  {filteredInvoices.map((invoice) => (
                    ...
                    >
                      <td className="py-3 px-4">
                        <Badge
                          variant="secondary"
                          className="font-mono text-xs bg-slate-100 text-slate-700 hover:bg-slate-100"
                        >
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <Badge
                      variant="secondary"
                      className="font-mono text-xs bg-slate-100 text-slate-700 hover:bg-slate-100 mb-1.5"
                    >
                      {invoice.invoice_number}
                    </Badge>
                ...
                <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 gap-1.5 text-xs h-8 text-blue-600 border-blue-200 hover:bg-blue-50"
                    onClick={() => onView(invoice)}
                  >
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 gap-1.5 text-xs h-8 text-amber-600 border-amber-200 hover:bg-amber-50"
                    onClick={() => onEdit(invoice)}
                  >
